...
class _CategoryCoursesScreenState extends State<CategoryCoursesScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.find<CourseController>().filterCoursesByCategory(widget.category);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final filteredCourses = courseController.filteredCourses;
      final isLoading = courseController.isLoading;
