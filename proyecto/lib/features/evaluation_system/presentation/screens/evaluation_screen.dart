...
import 'package:proyecto/features/evaluation_system/presentation/widgets/evaluation_form_widget.dart';
...
class _EvaluationScreenState extends State<EvaluationScreen> {
  ...
  Future<void> _loadEvaluations() async {
    ...
    await evaluationController.loadEvaluationsByGroup(
  ...
  List<String> get _availableUsers {
    return widget.group.members
        .where((member) => member != widget.evaluatorUsername)
        .toList();
  }
  ...
  Widget _buildEvaluationForm() {
    ...
    try {
      existingEvaluation = evaluationController.evaluations.firstWhere(
  ...
  Widget _buildProgressIndicator() {
    return Obx(() {
      ...
      final evaluationController = Get.find<EvaluationController>();
      final completedEvaluations = _availableUsers
          .where((user) => evaluationController.isEvaluationComplete(user))
          .length;
  ...
  Widget _buildTimeRemaining() {
    if (widget.category.evaluationEndDate == null) {
                  ...
                  Obx(() {
                    ...
                    return Column(
                      children: _availableUsers.map((username) {
                        final isCompleted = evaluationController
                            .isEvaluationComplete(username);
