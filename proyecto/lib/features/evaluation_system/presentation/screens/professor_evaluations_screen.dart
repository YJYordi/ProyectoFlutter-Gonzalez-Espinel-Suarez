...
import 'package:proyecto/shared/presentation/widgets/star_rating_widget.dart';
...
class ProfessorEvaluationsScreen extends StatefulWidget {
  ...
  @override
  State<ProfessorEvaluationsScreen> createState() =>
      _ProfessorEvaluationsScreenState();
}

class _ProfessorEvaluationsScreenState
    extends State<ProfessorEvaluationsScreen> {
  ...
  Widget _buildEvaluationSummary(List<EvaluationEntity> evaluations) {
    ...
    final progress = totalEvaluations > 0
              ...
              ...EvaluationCriteriaEntity.defaultCriteria.map((criteria) {
                ...
                return Padding(
                  ...
                  child: StarRatingDisplayWidget(
                    ...
                    spanishDescription:
                        criteria.spanishDescriptions[rating] ??
  ...
  List<EvaluationEntity> _getFilteredEvaluations(
    List<EvaluationEntity> allEvaluations,
  ) {
    return allEvaluations.where((evaluation) {
      if (_selectedCategoryId != null &&
          evaluation.categoryId != _selectedCategoryId) {
        return false;
      }
    ...
    return Scaffold(
      ...
      body: _isLoading
          ...
          : Obx(() {
              ...
              final allEvaluations = evaluationController.pendingEvaluations;
              final filteredEvaluations = _getFilteredEvaluations(
                allEvaluations,
              );
