...
class PersistentDataSource extends InMemoryDataSource {
  ...
  Future<void> initialize() async {
    try {
      ...
      debugPrint('Error initializing PersistentDataSource: $e');
      // En caso de error, cargar datos precargados
      await _loadPreloadedData();
    }
  }
  ...
  Future<void> _saveEnrollments() async {
    final prefs = await SharedPreferences.getInstance();
    final enrollmentsList = enrollments
        .map(
          (enrollment) => {
            'id': enrollment.id,
  ...
  Future<void> _loadPreloadedData() async {
    ...
    final preloadedCourses = [
      CourseEntity(
        ...
        description:
            'Aprende a desarrollar aplicaciones móviles con Flutter y Dart',
      ...
      CourseEntity(
        ...
        title: 'Diseño UI/UX',
        description:
            'Fundamentos del diseño de interfaces de usuario y experiencia',
