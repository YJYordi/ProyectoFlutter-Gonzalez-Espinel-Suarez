...
class PendingEvaluationsScreen extends StatefulWidget {
  ...
  @override
  State<PendingEvaluationsScreen> createState() => _PendingEvaluationsScreenState();
}
  ...
  Widget _buildFilterChips() {
    return Consumer<EvaluationProvider>(
      builder: (context, evaluationProvider, child) {
        ...
        final courses = evaluationProvider.pendingEvaluations
            .map((e) => e.courseId)
            .toSet()
            .toList();
          ...
          Expanded(
            child: _isLoading
                ...
                : Consumer<EvaluationProvider>(
                    builder: (context, evaluationProvider, child) {
                      if (evaluationProvider.pendingEvaluations.isEmpty &&
                          evaluationProvider.completedEvaluations.isEmpty) {
                      ...
                      return SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (evaluationProvider.pendingEvaluations.isNotEmpty) ...[
                              const Text(
                                'Evaluaciones Pendientes',
                                style: TextStyle(
                                  fontSize: 18,
                              ...
                              ...evaluationProvider.pendingEvaluations
                                  .map((evaluation) => _buildEvaluationCard(evaluation))
                                  .toList(),
                              const SizedBox(height: 24),
                            ],
                            
                            // Evaluaciones completadas
                            if (evaluationProvider.completedEvaluations.isNotEmpty) ...[
                              const Text(
                                'Evaluaciones Completadas',
                                style: TextStyle(
                                  fontSize: 18,
                              ...
                              const SizedBox(height: 12),
                              ...evaluationProvider.completedEvaluations
                                  .map((evaluation) => _buildCompletedEvaluationCard(evaluation))
                                  .toList(),
                            ],
                          ],
                        ),
